...
public class LectorQR extends AppCompatActivity {
    ...
    public void initQR(final int Asistencia) {
                ...
                if (barcodes.size() > 0) {
                    ...
                    if (!token.equals(tokenanterior)) {
                        ...
                        if (URLUtil.isValidUrl(token)) {
                            ...
                            Intent shareIntent = new Intent(LectorQR.this, Confirmar.class);
                           /* shareIntent.setAction(Intent.ACTION_SEND);
                            shareIntent.putExtra(Intent.EXTRA_TEXT, token);
                            shareIntent.setType("text/plain");*/
                            shareIntent.putExtra("Folio", token);
                            shareIntent.putExtra("Asistencia", Asistencia);
